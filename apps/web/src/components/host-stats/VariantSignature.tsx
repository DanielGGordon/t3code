...
// Placeholder for the "Signature" redesign — replaced by its design agent.
export function VariantSignature({ stats }: HostStatsVariantProps) {
  ...
  return (
    <div
      ...
      aria-label={detail}
    >
      <span>Signature {Math.round(stats.cpuPercent)}%</span>
