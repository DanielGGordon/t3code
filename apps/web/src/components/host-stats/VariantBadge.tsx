...
// Placeholder for the "Badge" redesign — replaced by its design agent.
export function VariantBadge({ stats }: HostStatsVariantProps) {
  ...
  return (
    <div
      ...
      aria-label={detail}
    >
      <span>Badge {Math.round(stats.cpuPercent)}%</span>
