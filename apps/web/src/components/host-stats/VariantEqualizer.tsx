...
// Placeholder for the "Equalizer" redesign — replaced by its design agent.
export function VariantEqualizer({ stats }: HostStatsVariantProps) {
  ...
  return (
    <div
      ...
      aria-label={detail}
    >
      <span>Equalizer {Math.round(stats.cpuPercent)}%</span>
