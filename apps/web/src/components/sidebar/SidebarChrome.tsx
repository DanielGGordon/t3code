...
// Lives in the shared chrome so it renders in both sidebar v1 and the v2 beta.
...
export const SidebarChromeFooter = memo(function SidebarChromeFooter() {
  ...
  return (
    <SidebarFooter className="p-2">
      ...
      <SidebarUpdatePill />
      <SidebarMenu>
        {/* Settings squished to its content, with the host-stats readout
            stretched across the remaining width. */}
        <SidebarMenuItem className="flex items-center gap-2">
          <SidebarMenuButton
            size="sm"
            className="h-8 w-auto shrink-0 items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium text-sidebar-muted-foreground/80 hover:bg-sidebar-row-hover hover:text-sidebar-foreground"
